                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    24, 0, 24, 0),
                                            child: Image.asset(
                                              'assets/images/638ef98649fff37b7e696584_Stationery-logo-generator.jpg',
                                              height: 250,
                                              fit: BoxFit.fill,
                                            ).animateOnPageLoad(animationsMap[
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0, 48, 0, 0),
                                            child: Text(
                                              'Introducing StatinaryWallah, your go-to instant stationary app.',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
                                          ...
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0, 48, 0, 0),
                                            child: Text(
                                              'Enjoy Quality Stationary delivered to your doorstep, quickly in minutes...',
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelLarge
